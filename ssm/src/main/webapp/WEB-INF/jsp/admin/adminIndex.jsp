...
<div id="rightSide">
    ...
    <div class="topNav">
        <div class="wrapper">
            <div class="welcome"><a href="javascript:void(0);" title=""><img src="/static/images/userPic.png" alt="" /></a><span>欢迎管理员<strong>【<c:out value="${sessionScope.currentUser.userName}"/>】</strong>使用本系统</span></div>
